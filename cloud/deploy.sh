...
RAPIDAPI_TIMEOUT_MS="${RAPIDAPI_TIMEOUT_MS:-20000}"
TRUST_PROXY="${TRUST_PROXY:-1}"
PLANEAGE_DEBUG="${PLANEAGE_DEBUG:-}"
...
gcloud run deploy "$WEB_SERVICE_NAME" \
  ...
  --set-env-vars "FAA_DATA_BACKEND=gcs,GCS_BUCKET=$GCS_BUCKET,GCS_MANIFEST_OBJECT=$GCS_MANIFEST_OBJECT,GCS_MANIFEST_CACHE_MS=60000,RAPIDAPI_TIMEOUT_MS=$RAPIDAPI_TIMEOUT_MS,TRUST_PROXY=$TRUST_PROXY${PLANEAGE_DEBUG:+,PLANEAGE_DEBUG=$PLANEAGE_DEBUG}" \
